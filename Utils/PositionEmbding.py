...
def RoPEattention(q, k, v, mask=None, dropout=None, use_RoPE=True):
...
if __name__ == '__main__':
    ...
    res, att_scores = RoPEattention(q, k, v, mask=None, dropout=None, use_RoPE=True)


    # (bs, head, seq_len, dk),  (bs, head, seq_len, seq_len)
    print(res.shape, att_scores.shape) # torch.Size([8, 12, 10, 32]) torch.Size([8, 12, 10, 10])
